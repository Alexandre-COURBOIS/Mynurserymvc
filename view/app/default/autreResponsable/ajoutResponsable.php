        ...
        if ($_SESSION['login']['user'] === "particulier") { ?>
            ...
            <div class="container">
                <form method="post" class="form-style" autocomplete="off">
                    <h2 id="sousTitre" class="text-center pt-4">Ajouter une autre personne ayant le droit de venir
                        chercher <?= ucfirst($enfant[0]->prenom); ?> à la crèche</h2>
                    <div class="form-row">
                        <div class="col-md-6 mx-auto mt-3">
                            <div class="form-row">
                                <div class="col-md-5 mx-auto mt-3">
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="nom_autreResp" id="nom_autreResp"
                                               ...
                                               value="<?php if (!empty($_POST['nom_autreResp'])) echo $_POST['nom_autreResp']; ?>">
                                ...
                                <div class="col-md-5 mx-auto mt-3">
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="prenom_autreResp"
                                               id="prenom_autreResp" placeholder="Prénom de la personne"
